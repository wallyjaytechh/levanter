...
module.exports = {
  ...
  SESSION_ID: (process.env.SESSION_ID || 'levanter_1f2341b1406aa4c9ea01bfe0dd9354307').trim(),
  DATABASE:
  ...
  BRANCH: 'master',
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || 'WALLYJAYTECH-MD',
  ...
  ANTIWORDS: process.env.ANTIWORDS || 'true',
